...
{
public:
  explicit CumotionInterface(const rclcpp::Node::SharedPtr & node, const std::string & group_name)
  : node_(node),
    action_client_(std::make_shared<CumotionMoveGroupClient>(node, group_name))
  {
  }
